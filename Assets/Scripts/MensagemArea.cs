...
public class MensagemArea : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        vozes = gameObject.GetComponent<AudioSource>();
        }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            jaAtivado = true;
            AudioSource.PlayClipAtPoint(vozes.clip, transform.position);
